...
function gameOver() {
  ...
  createExplosion(hero.mesh.position.clone(), 5, 0xdb3951, 1);

  //setTimeout(function(){
  //  gameStatus = "readyToReplay";
  //}, 4000);

  sendGameOver(Math.floor(distance));
}
...
function createExplosion(pos, radius, color, scale) {
  ...
  tl.to(particles.scale, 2, { x: 0.01, y: 0.01, z: 0.01, ease: Power2.easeOut })
    .to(particles.material, 2, { opacity: 0, ease: Power2.easeOut }, 0)
    .call(function() {
